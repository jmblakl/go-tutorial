...
func (*GCDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_gcd_306609f0840234ce, []int{0}
}
...
func (*GCDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_gcd_306609f0840234ce, []int{1}
}
...
func init() { proto.RegisterFile("gcd.proto", fileDescriptor_gcd_306609f0840234ce) }

var fileDescriptor_gcd_306609f0840234ce = []byte{
